...
export default function Project({ project, currentCategory }: Props) {
	return (
		<div className="bg-gray-900 border border-gray-800 rounded-lg flex flex-col sm:flex-row overflow-hidden flex-1 min-w-[300px] sm:min-w-[400px] max-w-[560px] min-h-[15rem] sm:max-h-[15rem]">
